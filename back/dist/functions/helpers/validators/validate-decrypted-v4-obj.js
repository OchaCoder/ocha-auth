 ...
 */
export const validateDecryptedV4Obj = (decryptedV4Obj) => {
    ...
    if (!Validator.Check(decryptedV4Obj)) {
        ...
        throw new ErrorDefensiveGuardBreach("ERR_MALFORMED_DECRYPTED_V4_OBJECT", "Token was successfully verified by Paseto v4, but the resulting structure was invalid. This may indicate a bug during token creation.", { specialJson: specialContext, debug: decryptedV4Obj });
    }
