...
/**
 * `runRedisGetExpecting` is part of the `runRedis` helper series,
 ...
 * - You want to handle `null` returns separately at the call site
 ...
 */
export declare const runRedisGetExpecting: <T extends TObject>(fastify: FastifyInstance, redisKey: string, userIdentifier: string | number | undefined, validator: TypeCheck<T>) => Promise<StaticDecode<T, []> | null>;
