import { ValidatorDecryptedPasetoObj, ValidatorPasetoSubRPT } from "../../validators.js";
/**
 * This function takes the returned object of V4.verify() as its argument,
 * and returns the validated object.
 */
export const validateDecryptedPasetoObj = (obj) => {
    // The structure of a decrypted paseto object...
    //  {
    //     sub: '{"email":"abc@email.com","token":"abcdefg12345"}',
    //     iat: '2025-04-08T03:35:46.178Z',
    //     exp: '2025-04-08T03:38:56.178Z'
    //   }
    if (!ValidatorDecryptedPasetoObj.Check(obj))
        throw new Error("");
