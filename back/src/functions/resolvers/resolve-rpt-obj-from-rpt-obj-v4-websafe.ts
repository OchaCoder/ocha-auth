...
export const resolveRptObjFromRptObjV4Websafe = async (reply: FastifyReply, rptObjV4Websafe: string, userIdentifier: string): Promise<{ rpt: string; id: number; email: string }> => {
