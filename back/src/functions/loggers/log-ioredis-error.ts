...
export const errLogIoredisFailedHealthCheck = (fastify: FastifyInstance) => {
...
export const errLogIoredisUserRequestNotFulfilled = (fastify: FastifyInstance, userIdentifier: string | number, userWait: number) => {
  console.error(`
              ----------------------------------------------------
...
export const errLogIoredisFailedOnStartUp = (fastify: FastifyInstance) => {
  let timeoutMessage
...
export const errLogIoredisUserRequestNotFulfilledUnknown = (fastify: FastifyInstance, err: Error, userIdentifier: string | number, userWait: number) => {
  return console.error(`
              ----------------------------------------------------
...
export const errLogIoredisTIMEDOUT = (fastify: FastifyInstance, err: Error) => {
  return console.error(`
  ----------------------------------------------------
  ${chalk.red("💥 [ERROR]".padEnd(20))}${chalk.red(`ioredis (@fastify/redis)`)}
  ${chalk.hex("#ff5733")("⏱️  [TIMESTAMP]".padEnd(20))} ${new Date().toISOString()}
...
export const errLogIoredisSocketTimeout = (fastify: FastifyInstance) => {
  return console.error(`
    ----------------------------------------------------
    ${chalk.red("💥 [ERROR]".padEnd(20))}${chalk.red(`ioredis (@fastify/redis)`)}
    ${chalk.hex("#ff5733")("⏱️  [TIMESTAMP]".padEnd(20))} ${new Date().toISOString()}
