...
// The only differences are the URL and that the "RESET_PASSWORD" modal is open by default.
//
// In modern design, user auth often appears as a modal over a semi-transparent overlay.
// A challenge arises when users directly visit a modal page URL (e.g. '/reset-password/')
